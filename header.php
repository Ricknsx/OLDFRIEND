                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <?php 
                        if(isset($_SESSION['usuario'])){
                                echo "<a class='dropdown-item' href='view/painel.php'>Meu Currículo</a>
                                <div class='dropdown-divider'></div>
                                <a class='dropdown-item' href='controller/logout.php'>Sair</a>";
                            
                        }
                        else{
                            echo "<a class='dropdown-item' href='view/login-cuidador.php'>Entrar</a>
                            <a class='dropdown-item' href='view/cadastro-cuidador.php'>Cadastre-se</a>";
                        }
                    ?>
                    <div>
                </div>
