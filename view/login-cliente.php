    ...
    <body>
        ...
        <section class="corpo-Login">
            ...
            <div class="margin-button">
                ...
                <a href="cadastro-cliente.php"><button  class="btn-cadastro-cliente"><b>CADASTRAR COMO CLIENTE</b><p>Forneca algumas informacoes, para efetuar<br>buscas por um profissional adequado a suas<br>necessidades</p></button></a>
